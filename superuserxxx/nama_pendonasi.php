      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="Nama_pendonasi.php"><i class="fa fa-circle-o"></i> Nama Pendonasi</a></li>
              </ul>
            </li>
          ...
          <li class="treeview">
            ...
            <li class="treeview">
              <a href="profil.php">
                <i class="fa fa-gears"></i><span>Profil</span>
              </a>
            </li>
            </ul>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Memasukkan NIK Pendaftar Hajatan Untuk Mencari Nama Pendonasi Pada Hajatanya</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
